...
//-------------------------------------------------------
	class ESPACIO_SHOWALL{
		...
		function __construct($lista,$datos){//constructor de la clase
			...
			$this->lista = $lista;	//lista de los atributos a mostrar
...
?>
			...
			<br>
			<br>
			<a href='../Controller/ESPACIO_Controller.php?action=ADD'><img src='../View/Icons/mas.png' width="25" height="25"></a>
			
			<a href='../Controller/ESPACIO_Controller.php?action=SEARCH'><img src='../View/Icons/buscar.png' width="25" height="25"></a>
