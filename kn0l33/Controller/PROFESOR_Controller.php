...
// la función get_data_form() recoge los valores que vienen del formulario por medio de post y la action a realizar, crea una instancia profesor y la devuelve
	...
	if (!isset($_POST['NOMBREPROFESOR'])){//compuebo si llega por el metodo POST
        $_POST['NOMBREPROFESOR'] = '';
    }
	if (!isset($_POST['APELLIDOSPROFESOR'])){//compuebo si llega por el metodo POST
        $_POST['APELLIDOSPROFESOR'] = '';
    }
	if (!isset($_POST['AREAPROFESOR'])){//compuebo si llega por el metodo POST
        $_POST['AREAPROFESOR'] = '';
    }
    if (!isset($_POST['DEPARTAMENTOPROFESOR'])){//compuebo si llega por el metodo POST
