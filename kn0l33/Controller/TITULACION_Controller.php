<?php
//Archivo : TUTULACION_Controller
//Creado el : 10/10/2019
//Creado por: kn0l33
//Función: controla la gestion de los TUTULACIONs
//-------------------------------------------------------
...
// la función get_data_form() recoge los valores que vienen del formulario por medio de post y la action a realizar, crea una instancia TITULACION y la devuelve
	...
	if (!isset($_POST['NOMBRETITULACION'])){//compuebo si llega por el metodo POST
        $_POST['NOMBRETITULACION'] = '';
    }
    if (!isset($_POST['RESPONSABLETITULACION'])){//compuebo si llega por el metodo POST
